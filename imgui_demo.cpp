...
// [SECTION] Example App: Simple Animation / ShowExampleAppLayout()
...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    if (!ImGui::Begin("ImGui", p_open, window_flags))
    {
    ...
    // Most "big" widgets share a common width settings by default. See 'Demo->Animation->Widgets Width' for details.
...
static void ShowDemoWindowWidgets(ImGuiDemoWindowData* demo_data)
{
    ...
    IMGUI_DEMO_MARKER("Game/Enemy");
    if (ImGui::TreeNode("Enemy"))
    {
        ImGui::SeparatorText("RadarFlag");
        ...
        IMGUI_DEMO_MARKER("Game/Basic/Checkbox");
        static bool check = false;
        if (ImGui::Checkbox("radar", &check))
        {
            SetRadarFlag(check);
        }
        ...
        // See 'Demo->Animation->Text Baseline Alignment' for details.
    ...
    //        ImGui::Checkbox("Game tree node as drag source", &test_drag_and_drop);
    //        ImGui::Text("Hello!");
    ...
    IMGUI_DEMO_MARKER("Game/Player");
    if (ImGui::TreeNode("Player"))
    {
        IMGUI_DEMO_MARKER("Game/Text/Colored Text");
        ...
        //IMGUI_DEMO_MARKER("Game/Text/Word Wrapping");
        ...
        IMGUI_DEMO_MARKER("Game/Text/UTF-8 Text");
    ...
    //IMGUI_DEMO_MARKER("Game/Multi-component Widgets");
...
static void ShowDemoWindowLayout()
{
    ...
    IMGUI_DEMO_MARKER("Animation/Widgets Width");
    ...
    IMGUI_DEMO_MARKER("Animation/Basic Horizontal Animation");
    if (ImGui::TreeNode("Basic Horizontal Animation"))
    {
        ImGui::TextWrapped("(Use ImGui::SameLine() to keep adding items to the right of the preceding item)");

        // Text
        IMGUI_DEMO_MARKER("Animation/Basic Horizontal Animation/SameLine");
        ...
        IMGUI_DEMO_MARKER("Animation/Basic Horizontal Animation/SameLine (with offset)");
        ImGui::Text("Aligned");
        ...
        // Checkbox
        IMGUI_DEMO_MARKER("Animation/Basic Horizontal Animation/SameLine (more)");
        ...
        // Dummy
        IMGUI_DEMO_MARKER("Animation/Basic Horizontal Animation/Dummy");
        ...
        IMGUI_DEMO_MARKER("Animation/Basic Horizontal Animation/Manual wrapping");
    ...
    IMGUI_DEMO_MARKER("Animation/Groups");
    ...
    IMGUI_DEMO_MARKER("Animation/Text Baseline Alignment");
    ...
    IMGUI_DEMO_MARKER("Animation/Scrolling");
    if (ImGui::TreeNode("Scrolling"))
    {
        // Vertical scroll functions
        IMGUI_DEMO_MARKER("Animation/Scrolling/Vertical");
        ...
        IMGUI_DEMO_MARKER("Animation/Scrolling/Horizontal");
        ImGui::Spacing();
        HelpMarker(
        ...
        IMGUI_DEMO_MARKER("Animation/Scrolling/Horizontal (more)");
        HelpMarker(
        ...
        if (show_horizontal_contents_size_demo_window)
        {
            ...
            IMGUI_DEMO_MARKER("Animation/Scrolling/Horizontal contents size demo window");
    ...
    IMGUI_DEMO_MARKER("Animation/Text Clipping");
    ...
    IMGUI_DEMO_MARKER("Animation/Overlap Mode");
...
void ShowExampleAppDocuments(bool* p_open)
{
    ...
    // Submit Tab Bar and Tabs
    {
        ...
        if (ImGui::BeginTabBar("##tabs", tab_bar_flags))
        {
            ...
            // [DEBUG] Stress tests
            //if ((ImGui::GetFrameCount() % 30) == 0) docs[1].Open ^= 1;            // [DEBUG] Automatically show/hide a tab. Game various interactions e.g. dragging with this on.
            //if (ImGui::GetIO().KeyCtrl) ImGui::SetTabItemSelected(docs[1].Name);  // [DEBUG] Game SetTabItemSelected(), probably not very useful as-is anyway..
...
struct ExampleAssetsBrowser
{
    ...
    {
        // Animation: when not stretching: allow extending into right-most spacing.
        LayoutItemSpacing = (float)IconSpacing;
        if (StretchSpacing == false)
            avail_width += floorf(LayoutItemSpacing * 0.5f);

        // Animation: calculate number of icon per line and number of lines
        LayoutItemSize = ImVec2(floorf(IconSize), floorf(IconSize));
        LayoutColumnCount = IM_MAX((int)(avail_width / (LayoutItemSize.x + LayoutItemSpacing)), 1);
        LayoutLineCount = (Items.Size + LayoutColumnCount - 1) / LayoutColumnCount;

        // Animation: when stretching: allocate remaining space to more spacing. Round before division, so item_spacing may be non-integer.
